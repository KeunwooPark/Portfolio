...
더불어서 네트워크 효과라는 것을 좀 더 넓게 해석해서 성장 전략 전반에 적용할 수 있을 것 같다는 생각이 들었다. 플랫폼 사업을 하지 않는다고 해도 성장을 위해서 네트워크라는 것은 큰 도움이 된다고 생각 한다. 지금 나는 놀잇감 회사에 다니고 있지만, 요즘 마케팅들도 네트워크 효과를 활용해야 한다고 생각한다. 다들 자신만의 채널(owned media)를 구축하고 이를 활용해서 마케팅을 하게 되기 때문에 바이럴리티를 많이 고민 하는 것같다. 바이럴이라는 것은 본질적으로 네트워크 효과를 이용하는 것이기에 어쩌면 비즈니스를 하는 모두가 읽어보면 좋을 책이라는 생각이 든다.
